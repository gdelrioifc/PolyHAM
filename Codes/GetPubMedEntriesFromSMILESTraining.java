...
public class GetPubMedEntriesFromSMILESTraining
{
 ...
 public static void main(String[] args) throws Exception
  {
   if(args.length==1)
   ...
   else
    {
     ...
     System.err.println("<infile> is the file named TableS1_Prestwick_STRINGWithNames.tsv in this dir.");
